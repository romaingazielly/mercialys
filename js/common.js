...
function blocCentreCo() {
	...
	$('#map-red').click(function(e){
		...
		if(curr != 'red') {
			$('#map-mercialys-pointer').animate({'background-position-x': '-124px'});
	...
	$('#map-green').click(function(e){
		...
		if(curr != 'green') {
			$('#map-mercialys-pointer').animate({'background-position-x': '-91px'});
			$('#map-mercialys-title').fadeOut('fast', function(){
	...
	$('#map-yellow').click(function(e){
		...
		if(curr != 'yellow') {
			$('#map-mercialys-pointer').animate({'background-position-x': '-57px'});
			$('#map-mercialys-title').fadeOut('fast', function(){
	...
	$('#map-black').click(function(e){
		...
		if(curr != 'black') {
			$('#map-mercialys-pointer').animate({'background-position-x': '-24px'});
			$('#map-mercialys-title').fadeOut('fast', function(){
	...
	$('#map-grey').click(function(e){
		...
		if(curr != 'grey') {
			$('#map-mercialys-pointer').animate({'background-position-x': '9px'});
			$('#map-mercialys-title').fadeOut('fast', function(){
